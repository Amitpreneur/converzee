...
export default class Create extends Component {
  ...
  componentDidMount() {
    ...
    // const itemId = this.props.location ? (this.props.location.state ? this.props.location.state.item : 1) : 1;
    //this.setState({ toolId: 1, toolName: ToolUtil.getTool(1), toolName: Util.CAMPAIGNS_NAME });
    // const item = this.props.location ? (this.props.location.state ? this.props.location.state.data : null) : null;
    // if (item) {
    //   this.setState({ ...item });
    // }
  }
  ...
  onClickSave = () => {
    ...
    if (!Util.isArrayEqual(emailInt, this.state, 3)) {
